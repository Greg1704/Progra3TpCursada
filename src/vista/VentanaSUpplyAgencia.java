...
public class VentanaSUpplyAgencia extends JFrame implements KeyListener, MouseListener{
	...
	public VentanaSUpplyAgencia() {
		...
		JPanel PanelGeneralAgencia = new JPanel();
		contentPane.add(PanelGeneralAgencia, BorderLayout.CENTER);
		PanelGeneralAgencia.setLayout(new GridLayout(0, 2, 0, 0));
		
		JPanel PanelFuncionalidades = new JPanel();
		PanelFuncionalidades.setBorder(new CompoundBorder());
		PanelGeneralAgencia.add(PanelFuncionalidades);
		...
		PanelGeneralAgencia.add(PanelListas);
