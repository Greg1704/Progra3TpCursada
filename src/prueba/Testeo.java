...
public class Testeo {
	...
	public static void main(String[] args) {
		...
		f1 = new FormularioDeBusqueda("HomeOffice",1,45000,1,"Media",1,"Junior",1,25,1,"Media",1,"Secundario",1);
		...
		f3 = new FormularioDeBusqueda("Presencial",1,130000,1,"Extendida",1,"Managment",1,32,1,"Mucha",1,"Terciario",1);
		...
		f4 = new FormularioDeBusqueda("HomeOffice",1,45000,1,"Media",1,"Junior",1,23,1,"Nada",1,"Terciario",1);
		t4 = new TicketEmpleado(LocalDateTime.now(),f4);
		e4 = new Empleado("Carla32","Michifus","Carla Lopez",42654839,223567543,23,"CABA",t4);
		
		f7 = new FormularioDeBusqueda("Indistinto",1,45000,1,"Completa",1,"Senior",1,42,1,"Media",1,"Secundario",1);
		...
		f5 = new FormularioDeBusqueda("Presencial",10,125000,1,"Extendida",5,"Managment",5,30,1,"Mucha",10,"Terciario",10);
		...
		f6 = new FormularioDeBusqueda("Presencial",10,45000,10,"Completa",5,"Junior",5,25,3,"Nada",1,"Primario",1);
